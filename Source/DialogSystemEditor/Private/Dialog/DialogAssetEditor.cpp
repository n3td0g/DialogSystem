...
#include "Dialog/DialogEditorNodes.h"
#include "QaDSEditor/QaDSGraphSchema.h"
#include "Dialog/DialogGraphSchema.h"
#include "EdGraph/EdGraph.h"
#include "Dialog/DialogNodes/DialogSubGraphNode.h"
#include "Dialog/DialogNodes/DialogElseIfNode.h"
...
{
	GEditor->GetEditorSubsystem<UAssetEditorSubsystem>()->CloseOtherEditors(Object, this);
	EditedAsset = Object;
...
void FDialogAssetEditor::BuildToolbar(FToolBarBuilder &builder)
{
	...
	AddToolbarWidget(builder.MakeWidget());
}
